...
- Internet IP (EIP): An Internet Elastic IP address that is bound to an LB instance of the Internet network type and provides Server Load Balancer access to the Internet or IDC data centers.
