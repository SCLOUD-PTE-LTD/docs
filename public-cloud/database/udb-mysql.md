...
| Enable read-write splitting free of charge to achieve load balancing, making read-write splitting easy to use | You need to implement or purchase Load Balancing alone | You need to implement or purchase a load balancing device alone |
